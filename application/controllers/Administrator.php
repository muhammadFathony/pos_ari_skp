...
class Administrator extends CI_Controller{
    ...
    function logout(){
        $data = array('masuk' , 'user','akses','idadmin','nama','user_id', 'user_nama', 'nama');
		$this->session->unset_userdata($data);
		//$this->session->set_flashdata('successMessage', '<div class="alert alert-warning">Sign Out Success</div>');
